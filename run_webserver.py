...
class Base_FNCHandler(BaseHandler):
    def post(self):
        ...
        try:
            ...
            val_param10 = ''
        res=base_fnk.fnk_lst(asid,orgid,val_param,val_param1,val_param2,val_param3,val_param4,val_param5,val_param6,val_param7,val_param8,val_param9,val_param10)
        if res == None:
            res=''
        #print(res)            
        self.write(res)
